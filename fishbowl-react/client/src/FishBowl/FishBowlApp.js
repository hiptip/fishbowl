            ...
            <Router>
                <Switch>
                    ...
                    <Route path="/join" render={withRouter((props) => <JoinSession {...props} 
                        ...
                        />)} />
                    <Route path="/create" render={withRouter((props) => <CreateCard {...props} state={this.state} socket={socket} />)} /><Route path="/create" render={withRouter((props) => <CreateCard {...props} state={this.state} socket={socket} />)} />
